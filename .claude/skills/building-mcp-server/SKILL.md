...
description: >
  ...
  external services through well-designed tools. Use when user says "MCP server", "MCP tools", "build MCP",
  "FastMCP", "MCP SDK", "MCP integration". Do NOT use for REST APIs (use building-backend-api),
  general agent building (use building-agent-core), RAG pipelines (use building-rag-pipeline),
  or frontend UIs (use building-ai-frontend).
